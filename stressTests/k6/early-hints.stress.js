// early-hints stress. Faithful to early-hints/tests/performance/performance.test.js v5 profile.
...
export default function () {
	if (URLS.length === 0) throw new Error('No URLS provided to early-hints stress');
