...
import hdbTerms from '#src/core/utility/hdbTerms';
import { join } from 'path';
import axios from 'axios';
import { encode } from 'cbor-x';
import analytics from '#src/core/resources/analytics/write';
import { bypassAuth } from '#src/core/security/auth';
import { bypassAuth as bypassAuthMQTT } from '#src/core/server/mqtt';
import environmentManager from '#js/core/utility/environment/environmentManager';
...
export async function setupTestApp() {
	...
	if (serverStarted) {
		...
		const { startHTTPThreads } = await import('#src/core/server/threads/socketRouter');
