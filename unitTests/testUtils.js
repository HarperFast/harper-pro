...
const env = require('#js/core/utility/environment/environmentManager');
const assert = require('node:assert');
const systemSchema = {};
const { table: ensure_table, resetDatabases } = require('#src/core/resources/databases');
const terms = require('#src/core/utility/hdbTerms');
const harperBridge = require('#js/core/dataLayer/harperBridge/harperBridge');
const { isMainThread } = require('node:worker_threads');
const { getDatabases } = require('#src/core/resources/databases');
const { handleHDBError } = require('#js/core/utility/errors/hdbError');
