...
// capability, home-map agreement, and level, 32..33 the ninth R4 pair, and 34..36 the cross-worker
// decode-drop resync budget (see the *_POSITION exports in replicationConnection.ts and DESIGN.md).
export const REPLICATION_SHARED_STATUS_SLOTS = 37;
