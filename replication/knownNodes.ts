...
export function getReplicationSharedStatus(
	...
	// error-time; see the *_POSITION exports in replicationConnection.ts); 13 is the record-lock
	// capability (RECORD_LOCKS_CAPABILITY_POSITION in recordLockTransport.ts), 14..15 headroom for
