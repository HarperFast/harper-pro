...
export function getReplicationSharedStatus(
	...
	// blob-divergence signals, 9..12 the W1 connection-truth fields (state/liveness/error-code/
	// error-time), and 13 the base-copy state (see the *_POSITION exports in
	// replicationConnection.ts); 14..15 are headroom for future metrics. This buffer is process-local shared memory (shared across this
